...
You can find detailed instructions [here](/platform/deployment-on-cloud/latest/deploy-on-virto-cloud).
...
1. [Install Platform latest version](/platform/developer-guide/latest/Getting-Started/Installation-Guide/windows) or connect to an instance of the platform that is already set up and running on a cloud service.
1. Install [Experience API/xAPI modules](/platform/developer-guide/latest/GraphQL-Storefront-API-Reference-xAPI):

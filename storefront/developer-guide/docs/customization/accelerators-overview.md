...
| Commit message convention   | `commitlint`                                | .commitlintrc.json                 | Enforces standard commit message format for readable history & changelogs.      |
...
| UI development (Storybook)  | `yarn storybook:dev` <br> `yarn storybook:build`     | .storybook/               | Develop and test UI components in isolation with Storybook.      |

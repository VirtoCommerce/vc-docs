...
| ![Account](media/account-overview.png) | <ul><li> [Distinguish personal and corporate accounts](account/overview.md)</li> <li>[Manage your profile](account/profile.md) </li> <li>[Create lists](account/lists.md) and [quote requests](account/quote-requests.md)</li> <li>[Upload company logo](account/company-info.md) </li> </ul>|
| ![Shopping](media/shopping-overview.png) | <ul><li> [Find a product](shopping/searching-for-products.md/)</li><li> [Create bulk orders](shopping/bulk-orders.md) </li> <li>[Compare products](shopping/compare-products.md)</li> <li>[Check out](shopping/checkout-process.md)</li> <li>[Review products](account/review-products.md)</li> <li>[Subscribe to back-in-stock notifications](shopping/back-in-stock-notifications.md)</li> </ul>|

...
* Read notifications.
* Quickly navigate through the catalog via the mega menu. You can navigate the menu using keyboard arrow keys. The mega menu can be hidden from anonymous users.

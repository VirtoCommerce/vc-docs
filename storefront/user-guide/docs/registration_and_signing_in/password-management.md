...
1. Click **Forgot your password?** in the sign in form:
    ...
    ![Forgot password](../media/forgot-your-password.png){: style="display: block; margin: 0 auto;" width="500"}
...
* At regular intervals set by the system. In this case, users are notified of the impending expiration:
    ...
    ![Password expiration](../media/password-about-to-expire.png){: style="display: block; margin: 0 auto;" width="500"}

If the password has expired, the user will be prompted to set a new password when logging in:

![Change expired password](../media/set-new-password.png){: style="display: block; margin: 0 auto;" width="500"}
...
1. Click **UPDATE**.
    ...
    ![Path](../media/profile-path-2.png){: style="display: block; margin: 0 auto;" width="500"}

...
<br>
<br>
![Create purchase request](../media/create-purchase-request.gif)

<br>

Next, [complete and submit the quote](quote-requests.md#complete-and-submit-quote-request), then [decline or approve the received proposal](quote-requests.md#approve-or-decline-quote-request).
...
![Edit purchase request](../media/edit-purchase-request.gif)
...
<div style="display: flex; justify-content: space-between;">
    ...
    <a href="../saved-for-later">Save for later →</a>
</div>
...
[![Latest release](media/latest_release.png)](https://github.com/VirtoCommerce/vc-module-sql-queries/releases)
...
* back up and restore SQL query definitions through the platform's standard [backup and restore mechanism](../backup-and-restore/overview.md).
...
<div style="display: flex; justify-content: space-between;">
    ...
    <a href="../running-queries">Running SQL queries →</a>
</div>
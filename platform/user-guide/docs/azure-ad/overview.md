...
![Readmore](media/readmore.png){: width="25"} [Using Azure AD as SSO provider on the Frontend](/storefront/developer-guide/latest/authentication/adding-sso-provider)

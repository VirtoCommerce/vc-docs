...
1. Configure advanced properties:
    ...
    1. [Fulfillment centers](inventory/managing-fulfillment-centers.md).
...
1. [Create a price list.](pricing/creating-new-price-list.md#create-new-price-list)
1. [Add items to the price list.](pricing/creating-new-price-list.md#add-products-to-price-list)
1. [Create price list assignment.](pricing/adding-new-assignment.md)
...
1. [Available shipments methods.](order-management/managing-documents.md#create-shipment-documents) 
1. [Taxes.](catalog/managing-categories.md#tax-type)
...
* [Managing loyalty programs.](loyalty/enable-and-configure-loyalty-programs.md)

...
|-----------	|---------------------------------------------------------------------------------------|--------------------------------------------------------	|
| Customers 	| Defines the customers the promotion is valid for. Provide at least one condition.   	| <ul><li>Everyone</li><li>User group</li><ul><li>Registered users</li><li>First time customers</li><li>User group contains...</li><li>User group is...</li> </ul> </ul>  <br> When adding a user group, you can open a list of customers belonging to the group: <br> ![User group customers](media/user-groups-customers.png) |

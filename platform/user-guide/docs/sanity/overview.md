...
[![Source code](media/source_code.png)](https://github.com/VirtoCommerce/vc-module-sanity/)

[![Download](media/latest_release.png)](https://github.com/VirtoCommerce/vc-module-sanity/releases/)
...
![Readmore](media/readmore.png){: width="25"} [Sanity module setup](../../../developer-guide/Extensibility/cms-integrations/sanity-setup)

...
Within the **Subscription** module, you can configure:
...
1. In the search field of the next blade, type **Subscription** to find the settings related to the module.
...
1. Type **Subscription** in the search bar and select the **Subscription** from the list.
1. In the next blade, configure the following:

    ![Store-specific settings](media/subscriptions-settings.png){: style="display: block; margin: 0 auto;" }

...
1. In the user details blade, click the **Loyalty balance** widget to open the loyalty operations log:
    ...
    ![Loyalty points history](media/loyalty-points-history.png){: style="display: block; margin: 0 auto;" }

1. Click any item to view its details:

    ![Details](media/loyalty-points-details.png){: style="display: block; margin: 0 auto;" }
...
<div style="display: flex; justify-content: space-between;">
    ...
    <a href="../managing-loyalty-missions">Managing loyalty missions →</a>
</div>

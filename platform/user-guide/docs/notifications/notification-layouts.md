...
The **Notification layouts** option allows you to manage the existing layouts and add new ones. Layouts define the formatting for your [notification templates](notification-templates.md) and mostly use HTML and CSS languages, so you might need help from your web designers to configure them.
...
1. Preview your layout in the **Preview** tab.

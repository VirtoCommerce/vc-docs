...
The **Quote (Quotes)** module represents quote management system. You can view the list of [submitted quotes](/storefront/user-guide/latest/shopping/submit-quotes) via this module.
...
With the Quote module, users get:

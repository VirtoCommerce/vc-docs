...
Within the **White labeling** module, you can configure:
...
1. In the search field of the next blade, type **White labeling** to find the settings related to the module.
1. In the next blade,  specify the theme preset name.
...
<div style="display: flex; justify-content: space-between;">
    <a href="../customizing-brand-elements">← Customizing brand elements</a>

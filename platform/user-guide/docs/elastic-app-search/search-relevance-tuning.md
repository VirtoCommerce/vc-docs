...
For example, your customers might search for a **duplicator** on the Frontend, but don't find any matching product:
...
Built on top of Elasticsearch, App Search is a managed service and an expertly crafted distillation of its best features. It provides tools to help you further tune the search experience to optimize for your own needs.

![Readmore](media/readmore.png){: width="25"} [Relevance tuning guide](https://www.elastic.co/guide/en/app-search/8.12/relevance-tuning-guide.html)

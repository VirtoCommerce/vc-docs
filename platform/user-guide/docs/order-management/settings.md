...
![Settings-path](media/settings-path.png){: style="display: block; margin: 0 auto;" width="700"}
...
![Order templates](media/order-templates.png){: style="display: block; margin: 0 auto;" }

...
1. In the **Edit order details and related documents** blade, click the **Indexation** widget.
1. In the next blade, click **Build index**.

    ![New payment document](media/indexation.png){: style="display: block; margin: 0 auto;" }

1. The result of indexing is displayed in the next blade.

    ![Indexation completed](media/indexation-completed.png){: style="display: block; margin: 0 auto;" }

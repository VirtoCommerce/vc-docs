...
The vc-testing-module does not include accessibility testing. Since it's already Playwright-based, `axe-playwright-python` is the natural library to add for WCAG rule checks. It is not bundled today.

...
![Readmore](media/readmore.png){: width="25"} [Virto Commerce release strategy overview](/platform/developer-guide/latest/Updating-Virto-Commerce-Based-Project/release-strategy-overview)

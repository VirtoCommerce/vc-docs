...
1. In the product blade, click the index widget.
...
* **Time-based**: A background job checks and reindexes modified objects every X minutes (5 by default). This type is disabled by default.

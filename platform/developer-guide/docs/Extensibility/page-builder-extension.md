...
Frontend developers can add or edit Page Builder blocks in Virto Commerce Frontend to simplify the customization process. 
<br>
<br>
...
!!! note
    ...
    + If a section with the same name already exists in the Page Builder, it will be overwritten.

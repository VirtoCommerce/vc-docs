...
* New user registers on the Frontend UI.

## Email verification in Platform API

![Email verification in Platform](media/email-verification.png){: style="display: block; margin: 0 auto;" width="950"}
...
![Email verification in xAPI](media/email-verification-1.png){: style="display: block; margin: 0 auto;" width="950"}
...
![Email verification in Storefront](media/email-verification-2.png){: style="display: block; margin: 0 auto;" width="950"}

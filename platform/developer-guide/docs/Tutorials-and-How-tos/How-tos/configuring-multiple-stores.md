...
1. Deploy the [Virto Commerce Platform](/platform/developer-guide/latest/Getting-Started/Installation-Guide/windows) and [Frontend Application](/storefront/developer-guide/latest/deployment). 

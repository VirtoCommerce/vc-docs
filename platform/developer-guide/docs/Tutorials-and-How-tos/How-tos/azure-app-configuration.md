...
![Readmore](media/readmore.png){: width="25"} [Configuring and Managing Azure AD Authentication in Virto Commerce Platform](/platform/developer-guide/latest/Fundamentals/Security/extensions/adding-azure-as-sso-provider)

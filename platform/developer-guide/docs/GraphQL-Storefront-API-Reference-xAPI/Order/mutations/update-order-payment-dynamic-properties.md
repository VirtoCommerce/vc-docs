...
| Field                                     | Description                                                                                                   |
|-------------------------------------------|---------------------------------------------------------------------------------------------------------------|
| `orderId`  ==String==                     | An optional Id of the order for which the order payment's dynamic properties will be updated.        |
| `paymentId`  ==String==                   | An optional Id of the order payment for which the dynamic properties will be updated.                |
...
<div style="display: flex; justify-content: space-between;">
    <a href="../update-order-shipment-dynamic-properties">← UpdateOrderShipmentDynamicProperties mutation</a>

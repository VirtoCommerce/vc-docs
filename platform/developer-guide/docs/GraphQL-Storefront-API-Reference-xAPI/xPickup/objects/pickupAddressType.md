...
This type represents the physical address and related contact information for a pickup location.
...
| `postalCode` ==String==   | The postal or ZIP code of the address.                        |

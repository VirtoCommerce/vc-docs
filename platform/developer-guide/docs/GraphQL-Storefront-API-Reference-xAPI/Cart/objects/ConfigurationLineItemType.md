...
| `product` [ ==Product== ](../../Catalog/queries/product.md)               | The product associated with this configuration line item.             |  
| `currency` [ ==CurrencyType!== ](../../Order/objects/currency-type.md)    | The currency associated with the configuration item.                  |  

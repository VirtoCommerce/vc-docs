...
!!! note
    You can configure additional authentication methods, such as signing in via [Google](../../../../../storefront/developer-guide/authentication/adding-google-as-sso-provider#manage-platform-settings) or [Entra ID (formerly Azure AD)](../../../../../storefront/developer-guide/docs/authentication/adding-sso-provider.md).
...
1. In the **New catalog** blade, choose the catalog type: physical or virtual. In our example, we are creating a physical catalog.
    ...
    ![Read more](media/readmore.png){: width="30"} [Learn more about physical and virtual catalogs](../../../../user-guide/catalog/add-new-catalog)

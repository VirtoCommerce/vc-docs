...
<!-- Source: core/blade-navigation/table-query-state/useTableQueryState.docs.md -->
...
- [`useDataTablePagination`](./useDataTablePagination.md) — pagination state composable (`setPage` for restore seed)

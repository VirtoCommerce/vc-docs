...
For the canonical blade-side example and the registration of notification types at module load, see the [Notifications system reference](../../plugins/notifications.md).
...
- [Notification system reference](../../plugins/notifications.md) -- includes the recommended `useBladeNotifications` composable with blade lifecycle integration

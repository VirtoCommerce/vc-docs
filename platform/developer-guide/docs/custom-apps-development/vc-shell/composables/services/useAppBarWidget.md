...
- Blade toolbar actions — declare an `IBladeToolbar[]` array and bind it via `<VcBlade :toolbar-items>`; see [useToolbar](./useToolbar.md) for the advanced dynamic-registration API

...
- For rich panel content with header/footer/scrollable body -- use [VcPopover](./vc-popover.md)
...
- [VcPopover](./vc-popover.md) -- floating panel with header, footer, and scrollable content

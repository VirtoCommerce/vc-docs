...
| One-off confirmation or input dialog              | [VcPopup](../feedback/vc-popup.md)                      |
| Full-page route without blade stack               | Vue Router view                                              |
| Scrollable content section inside a blade         | [VcContainer](./vc-container.md) |

...
![Readmore](media/readmore.png){: width="25"}  [How to enable authentication with Google OAuth 2.0 on the Frontend](/storefront/developer-guide/latest/authentication/adding-google-as-sso-provider)

...
Use this query to fetch a list of orders with specific details.
...
## Getting order lineitem statuses

Use this query to get information about a specific order as well as an array of items with their respective statuses.
